        ...
        return Column(children: [
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _tooltipReply(messageController, "I’m on the way"),
                _tooltipReply(messageController, "I have arrived"),
                _tooltipReply(messageController, "Please come to pickup point"),
                _tooltipReply(messageController, "Please wait 2 minutes"),
                _tooltipReply(messageController, "Call me please"),
              ],
            ),
          ),
    ...
    return Padding(
      ...
      child: Tooltip(
        ...
        child: InkWell(
          ...
          onTap: () {
            messageController.conversationController.text = text;
            messageController.sendMessage(
              widget.channelId,
              widget.tripId,
            );
