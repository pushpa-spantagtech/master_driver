...
class OngoingParcelListViewWidget extends StatefulWidget {
  ...
  const OngoingParcelListViewWidget(
      {super.key, required this.title, required this.parcelListModel});

  @override
  State<OngoingParcelListViewWidget> createState() =>
      _OngoingParcelListViewWidgetState();
}

class _OngoingParcelListViewWidgetState
    extends State<OngoingParcelListViewWidget> {
  @override
      ...
      body: ListView.builder(
          ...
          itemBuilder: (context, index) {
            return ParcelRequestCardWidget(
                rideRequest: widget.parcelListModel.data![index], index: index);
          }),
    );
  }
}
