                            ...
                            onTap: () {
                              if (profileController.profileTypeIndex == 0) {
                                ...
                                Get.to(() => VehicleAddScreen(
                                    vehicleInfo: profileInfo.vehicle));
                              }
                            },
                            child: Row(
                          ...
                          profileController.profileTypeIndex == 0
                            ...
                            child: Column(children: [
                              ...
                              ProfileItemWidget(
                                ...
                                value: profileInfo.identificationType?.tr ?? 'N/A',
                            ...
                            child: Column(children: [
                              ProfileItemWidget(
                                ...
                                value: profileInfo.vehicle?.category?.name ?? 'N/A',
                                icon: Icons.category,
                              ),
                              ProfileItemWidget(
                                  title: 'vehicle_brand',
                                  value: profileInfo.vehicle?.brand?.name ??
                                      '',
                              ...
                              ProfileItemWidget(
                                ...
                                value: profileInfo.vehicle?.licencePlateNumber ??
                                    '',
                                icon: Icons.badge,
                              ),
                              ProfileItemWidget(
                                ...
                                value: DateConverter
                                  ...
                                  profileInfo.vehicle?.licenceExpireDate ??
                                      '',
                                ),
                              ...
                              ProfileItemWidget(
                                title: 'fuel_type',
                                value: profileInfo.vehicle?.fuelType ??
                                    '',
                            ...
                            child: Column(children: [
                              ...
                              ? !(profileController.levelModel?.data?.isCompleted ?? false)
                              ? Column(
                              crossAxisAlignment:
