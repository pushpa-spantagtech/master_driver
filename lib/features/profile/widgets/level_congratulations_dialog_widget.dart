            ...
            child: SizedBox(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                if (rewardType == 'wallet' ||
                  ...
                  Text(
                    '${'you_have_earned'.tr} '
                    '${rewardType == 'wallet' ? PriceConverter.convertPrice(Get.context!, double.parse(reward)) : '${double.parse(reward).toInt()} ${'points'.tr}'}',
                    style: textBold.copyWith(
                        color: Theme.of(context).textTheme.bodyLarge!.color),
                  ),
                  const SizedBox(height: Dimensions.paddingSizeDefault),
                ...
                Text(
                  levelName.isNotEmpty
                      ? '${'level_note'.tr}$levelName'
                      : 'maximum_level_note'.tr,
                  style:
                ...
                ButtonWidget(
                  ...
                  margin: const EdgeInsets.symmetric(
                      vertical: Dimensions.paddingSizeSmall, horizontal: 90),
                ),
              ]),
            ),
          ),
