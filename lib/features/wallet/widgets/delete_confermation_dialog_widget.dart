...
class DeleteConfirmationDialogWidget extends StatelessWidget {
  ...
  const DeleteConfirmationDialogWidget(
      {super.key, this.fromFailed = false, this.methodId});
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            child: Padding(
              ...
              child: Icon(CupertinoIcons.delete_solid,
                  size: 30.0, color: Theme.of(context).cardColor),
            ),
          ),
          ...
          if (!fromFailed) ...[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
              ...
              InkWell(
                overlayColor: WidgetStateProperty.all(Colors.transparent),
                onTap: () => Get.find<WalletController>()
                    .deleteWithdrawMethodInfo(methodId ?? ''),
                child: Container(
                  width: Get.width * 0.3,
                  height: Get.height * 0.05,
                  decoration: BoxDecoration(
