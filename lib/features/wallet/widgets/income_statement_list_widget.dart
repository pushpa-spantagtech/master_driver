...
class IncomeStatementListWidget extends StatefulWidget {
  ...
  @override
  State<IncomeStatementListWidget> createState() =>
      _IncomeStatementListWidgetState();
}
            ...
            ? Padding(
                ...
                child: PaginatedListViewWidget(
                  ...
                  offset: (widget.walletController.incomeStatement != null &&
                          widget.walletController.incomeStatement!.offset !=
                              null)
                      ? int.parse(widget
                          .walletController.incomeStatement!.offset
                          .toString())
                      : null,
                  ...
                  itemView: ListView.builder(
                    itemCount:
                        widget.walletController.incomeStatementData!.length,
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return IncomeStatementCardWidget(
                          tripDetails: widget
                              .walletController.incomeStatementData![index]);
                    },
                  ),
                ),
              )
