...
class PendingSettledListWidget extends StatefulWidget {
  ...
  @override
  State<PendingSettledListWidget> createState() =>
      _PendingSettledListWidgetState();
}
  ...
  Widget build(BuildContext context) {
    return widget.walletController.pendingSettledWithdrawModel != null
        ? widget.walletController.pendingSettledWithdrawModel!.data != null &&
                widget.walletController.pendingSettledWithdrawModel!.data!
                    .isNotEmpty
            ? Padding(
                ...
                child: PaginatedListViewWidget(
                  ...
                  totalSize: widget
                      .walletController.pendingSettledWithdrawModel!.totalSize,
                  offset:
                      (widget.walletController.pendingSettledWithdrawModel !=
                                  null &&
                              widget.walletController
                                      .pendingSettledWithdrawModel!.offset !=
                                  null)
                          ? int.parse(widget.walletController
                              .pendingSettledWithdrawModel!.offset
                              .toString())
                          : null,
                  onPaginate: (int? offset) async {
                    ...
                    widget.walletController.selectedHistoryIndex == 1
                        ? await widget.walletController
                            .getWithdrawPendingList(offset!)
                        : await widget.walletController
                            .getWithdrawSettledList(offset!);
                  },
                  itemView: ListView.builder(
                    itemCount: widget.walletController
                        .pendingSettledWithdrawModel!.data!.length,
                    padding: const EdgeInsets.all(0),
                    physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context, int index) {
                      return PendingSettledCardWidget(
                        pendingSettleInfo: widget.walletController
                            .pendingSettledWithdrawModel!.data![index],
                      );
                    },
                  ),
                ),
